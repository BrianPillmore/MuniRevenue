...
# Serve the built frontend.  Static assets (JS, CSS, images) are mounted
# under /assets so they don't collide with API routes.  A catch-all GET
# returns index.html for SPA client-side routing.
